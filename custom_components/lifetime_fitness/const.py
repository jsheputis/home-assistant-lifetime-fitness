...
CONF_DEFAULT_START_OF_WEEK_DAY = 0  # Monday
...
API_CLUB_VISITS_ENDPOINT_FORMATSTRING = (
    "https://api.lifetime.life/myaccount-club-visits-gateway-api/members/"
    "{member_id}/club-visits?endDate={end_date}&startDate={start_date}"
)
